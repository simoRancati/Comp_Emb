...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Weistress_Distance/AIME/Official_simulation/Neigboour_10/12Trimester/' # where save the file
# columns in metadata

...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Weistress_Distance/AIME/Official_simulation/Neigboour_1/1Trimester/' # where save the file
# columns in metadata

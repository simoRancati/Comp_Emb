...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Weistress_Distance/AIME/Official_simulation/AE_0_98/123Trimester/' # where save the file
# columns in metadata
...
autoencoder = build_noisy_autoencoder(input_dim=32, latent_dim=latent_dim, noise_factor=noise_factor)
...
df_conf.to_csv(path_save_file + 'conf_mat_over_time_wd_ae.tsv', sep='\t', index=None)

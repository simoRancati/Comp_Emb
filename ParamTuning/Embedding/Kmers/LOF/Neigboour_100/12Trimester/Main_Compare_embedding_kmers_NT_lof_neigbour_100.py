...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Kmers/AIME/Official_simulation/Neigboour_100/12Trimester/' # where save the file
# columns in metadata
...
df_conf.to_csv(path_save_file + 'conf_mat_over_time_kmers_lof.tsv', sep='\t', index=None)

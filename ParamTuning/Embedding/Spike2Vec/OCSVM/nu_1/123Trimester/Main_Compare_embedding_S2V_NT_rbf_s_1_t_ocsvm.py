...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Spike2Vec/AIME/Official_simulation/nu_1/123Trimester/' # where save the file
# columns in metadata
...
clf_c = OneClassSVM(kernel = 'rbf', gamma = 'scale', nu = 0.9,shrinking = True)
clf_c.fit(train)

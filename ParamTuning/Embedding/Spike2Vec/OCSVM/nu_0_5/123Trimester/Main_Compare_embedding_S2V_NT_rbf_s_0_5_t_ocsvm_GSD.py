...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Spike2Vec/AIME/Official_simulation/nu_0_5/123Trimester/' # where save the file
# columns in metadata
...
clf_c = SGDOneClassSVM(nu = 0.5,random_state=42)
clf_c.fit(train)

...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Spike2Vec/AIME/Official_simulation/Simulation/LOF/' # where save the file
# columns in metadata
...
clf_c = LocalOutlierFactor(n_neighbors=10, novelty=True)
clf_c.fit(train)

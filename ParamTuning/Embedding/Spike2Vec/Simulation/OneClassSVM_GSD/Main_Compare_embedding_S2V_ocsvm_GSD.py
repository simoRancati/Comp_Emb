...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Spike2Vec/AIME/Official_simulation/Simulation/OneClassSVM_GSD/' # where save the file
# columns in metadata
...
df_conf.to_csv(path_save_file + 'conf_mat_over_time_s2v_ocsvm_GSD.tsv', sep='\t', index=None)

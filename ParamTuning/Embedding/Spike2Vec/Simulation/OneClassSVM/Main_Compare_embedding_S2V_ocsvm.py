...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Spike2Vec/AIME/Official_simulation/Simulation/OneClassSVM/' # where save the file
# columns in metadata
...
clf_c = OneClassSVM(kernel = 'rbf', gamma = 'scale', nu = 0.01,shrinking = True)
clf_c.fit(train)
...
df_conf.to_csv(path_save_file + 'conf_mat_over_time_s2v_ocsvm.tsv', sep='\t', index=None)

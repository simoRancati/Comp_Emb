...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Spike2Vec/AIME/Official_simulation/Simulation/IF/' # where save the file
# columns in metadata
...
clf_c = IsolationForest(n_estimators=1000,random_state=0)
clf_c.fit(train)
...
df_conf.to_csv(path_save_file + 'conf_mat_over_time_s2v.tsv', sep='\t', index=None)

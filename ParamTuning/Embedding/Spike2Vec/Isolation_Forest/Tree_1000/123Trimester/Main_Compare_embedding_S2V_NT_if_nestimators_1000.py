...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Spike2Vec/AIME/Official_simulation/Tree_1000/123Trimester/' # where save the file
# columns in metadata
...
y_test_i_predict = clf_c.fit_predict(test_step_tot[1:])

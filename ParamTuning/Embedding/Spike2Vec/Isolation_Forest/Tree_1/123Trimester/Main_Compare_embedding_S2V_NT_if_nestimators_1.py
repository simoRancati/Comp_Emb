...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Spike2Vec/AIME/Official_simulation/Tree_1/123Trimester/' # where save the file
# columns in metadata
...
clf_c = IsolationForest(n_estimators=1,random_state=0)
clf_c.fit(train)

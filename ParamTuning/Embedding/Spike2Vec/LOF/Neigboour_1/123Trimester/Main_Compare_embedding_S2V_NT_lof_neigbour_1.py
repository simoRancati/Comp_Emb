...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Spike2Vec/AIME/Official_simulation/Neigboour_1/123Trimester/' # where save the file
# columns in metadata
...
clf_c = LocalOutlierFactor(n_neighbors=1)
clf_c.fit(train)

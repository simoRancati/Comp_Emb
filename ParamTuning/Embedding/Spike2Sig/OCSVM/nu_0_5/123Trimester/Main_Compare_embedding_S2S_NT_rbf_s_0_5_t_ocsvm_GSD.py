...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/Spike2Sig/AIME/Official_simulation/nu_0_5/123Trimester/' # where save the file
# columns in metadata
...
df_conf.to_csv(path_save_file + 'conf_mat_over_time_s2s_ocsvm_GSD.tsv', sep='\t', index=None)
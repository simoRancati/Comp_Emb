...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/AutoEncoder_KM/AIME/Official_simulation/Neigboour_100/123Trimester/' # where save the file
# columns in metadata

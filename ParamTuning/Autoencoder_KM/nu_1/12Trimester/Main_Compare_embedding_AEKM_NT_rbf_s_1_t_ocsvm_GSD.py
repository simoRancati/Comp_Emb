...
path_save_file= '/blue/salemi/share/varcovid/SECONDO_ANNO/Pipeline/AutoEncoder_KM/AIME/Official_simulation/nu_1/12Trimester/' # where save the file
# columns in metadata
...
# training one class
p_grid = {'kernel': ['rbf'], 'gamma': ['scale'], 'nu': [0.9],'shrinking': [True]}
